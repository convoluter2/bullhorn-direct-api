...
- Only retries entities that actually faile
  ...
  const failedMappings = failedDownloads.map
...
67890-Candidate-John_Doe.zip
   - Only failed uploads are r


Resume-JohnDoe.pdf
1. **Browser Download Folder:** Cannot p
Blank-Unknown.docx
