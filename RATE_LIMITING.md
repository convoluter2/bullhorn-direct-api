...
4. Maximum concurrent requests is configurable (default: 3)
5. Minimum delay between requests is enforced (default: 100ms)
...
The rate limiter can be configured programmatically:

```typescript
import { bullhornAPI } from '@/lib/bullhorn-api'

// Set maximum concurrent requests (1-10)
bullhornAPI.setMaxConcurrentRequests(5)

// Set minimum delay between requests (milliseconds)
bullhornAPI.setMinDelay(200)
...
- Default max concurrent requests: 3
...
- **Min Request Delay**: 100ms (default, configurable)
- **Max Concurrent**: 3 requests (default, configurable)
