...
function App() {
  ...
  useEffect(() => {
    const checkTokenExpiry = async () => {
      ...
      const currentConnId = currentConnectionId

      if (!currentSession || !currentSession.refreshToken || !currentSession.expiresAt || !currentConnId) {
        return
      }
      ...
      try {
        ...
        console.warn('⚠️ Session awareness check failed (KV likely unavailable or disabled), continuing with token refresh check')
      }
